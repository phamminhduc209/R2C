...
<?php $this->load->view('site/r2c/slide', $this->data);?>
                        ...
                        <div class="inner">
                            ...
                            <div class="product-r2c w-product">
                                ...
                                <div class="block-button-item">
                                    <a href="javascript:;" data-id="<?=$row->id?>" class="btn-add-cart-icon btn_add_cart btn-mua" data-tab="r2c" data-type="<?php if($row->price_sell > 0 && $row->member_price_sell > 0): ?>1<?php endif; ?>"><i class="fa fa-shopping-cart"></i></a>
