    ...
    <div class="row">
      <div class="col-sm-12 main-col">
        <div class="block block-title">
          <h1 class="heading-primary darken">Yêu cầu từ khách hàng</h1>
        </div>
    		<div class="block-title"><h2 class="heading-small darken">Thông tin khách hàng</h2></div>
        ...
        <script type="text/javascript">
          $(document).ready(function(){
    		...
    		<hr>
        <?php if(isset($yeucau) && $yeucau):?>
  			<div class="block-title"><h2 class="heading-small darken">Các câu hỏi</h2></div>
  			<div class="block-content">
			    <div id="accordion" class="panel-group">
            <?php foreach($yeucau as $key=>$row):?>
				    <div class="panel">
