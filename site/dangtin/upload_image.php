    ...
    <div class="m_post-product">
        ...
        <form action="<?php echo base_url('dangtin/upload_image'); ?>" class="m_upload_images--form clearfix" id="formContent" method="POST" enctype="multipart/form-data" >            
            <div class="m_upload_images">
                ...
                <div class="m_upload_images--content">                    
                        <div class="m_upload_images--uploadFile">
                            <label for="upload1" title="Upload photo"  class="m_upload_images--camera" focus="1">
                            ...
                            <label for="upload1" class="m_upload_images--upload">
                                <img src="" focus="1" class="m_upload_images--imageReader" style="display: none;">
                            </label>
                            <input  type="file" name="image" data-focus="1" class="m_upload_images--chooseFile" id="upload1" />                            
                            <a href="javascript:;" class="m_upload_images--Close" focus="1" style="display: none;">x</a>
                        </div>                  
                </div>
            </div>
            ...
            <div class="m_upload_images">
                ...
                <div class="m_upload_images--content">                    
                        <div class="m_upload_images--uploadFile">
                            <label for="upload2" title="Upload photo" focus="2"  class="m_upload_images--camera">
                                <span class="m_upload_images--text1">+ Upload</span><br>
                                <span class="m_upload_images--text2">Kích thước upload<br>600 x 600 px<br>Hình chụp rõ nét</span>                                
                            </label>
                            <label for="upload2" >                                
                                <img  class="m_upload_images--imageReader" focus="2" style="display: none;">
                            </label>
                            <input  type="file" name="image_list[]" data-focus="2" class="m_upload_images--chooseFile" id="upload2" />
                            <a href="javascript:;" class="m_upload_images--Close" focus="2" style="display: none;">x</a>         
                        </div>
                        <div class="m_upload_images--uploadFile">
                            <label for="upload3" title="Upload photo" focus="3" class="m_upload_images--camera">
                                <span class="m_upload_images--text1">+ Upload</span><br>
                                <span class="m_upload_images--text2">Kích thước upload<br>600 x 600 px<br>Hình chụp rõ nét</span>
                            </label>
                            <label for="upload3" >
                                <img  class="m_upload_images--imageReader" focus="3" style="display: none;">
                            </label>
                            <input  type="file" name="image_list[]" data-focus="3" class="m_upload_images--chooseFile" id="upload3" />
                            <a href="javascript:;" class="m_upload_images--Close" focus="3" style="display: none;">x</a>          
                        </div>
                        <div class="m_upload_images--uploadFile">
                            <label for="upload4" title="Upload photo" focus="4" class="m_upload_images--camera">
                                <span class="m_upload_images--text1">+ Upload</span><br>
                                <span class="m_upload_images--text2">Kích thước upload<br>600 x 600 px<br>Hình chụp rõ nét</span>
                            </label>
                            <label for="upload4" >
                                <img  class="m_upload_images--imageReader" focus="4" style="display: none;">
                            </label>
                            <input  type="file" name="image_list[]" data-focus="4" class="m_upload_images--chooseFile" id="upload4">
                            <a href="javascript:;" class="m_upload_images--Close" focus="4" style="display: none;">x</a>        
                        </div>
                        <div class="m_upload_images--uploadFile">
                            <label for="upload5" title="Upload photo" focus="5" class="m_upload_images--camera">
                                <span class="m_upload_images--text1">+ Upload</span><br>
                                <span class="m_upload_images--text2">Kích thước upload<br>600 x 600 px<br>Hình chụp rõ nét</span>
                            </label>
                            <label for="upload5" >
                                <img  class="m_upload_images--imageReader" focus="5" style="display: none;">
                            </label>                            
                            <input  type="file" name="image_list[]" data-focus="5" class="m_upload_images--chooseFile"  id="upload5" />
                            <a href="javascript:;" class="m_upload_images--Close" focus="5" style="display: none;">x</a>          
                        </div>
