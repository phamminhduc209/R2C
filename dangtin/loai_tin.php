...
<div class="block container">
    <div class="m_post-product">
        ...
        <div class="m_button m_button__style2">
            ...
            <a class="btn btn-primary btn-next" data-href1="<?php echo base_url('dang-tin-ban/danh-muc'); ?>?post_type=1" data-href2="<?php echo base_url('dang-tin-ban/thong-tin-san-pham'); ?>" href="<?php echo $this->session->userdata('post_type') == 2 ? base_url('dang-tin-ban/thong-tin-san-pham') : base_url('dang-tin-ban/danh-muc').'?post_type=1'; ?>" id="btnNext" title="Tiếp tục">Tiếp tục <i class="fa fa-angle-right"></i></a>            
        </div>
    </div>
</div>
